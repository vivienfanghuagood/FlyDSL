...
# FlyDSL
from kernels.wmma_decode_attention import compile_decode_attention_elemwise
...
def main():
    ...
    # === Triton ===
    q, k_buf, v_buf, o, kv_indptr, kv_indices, num_splits, max_splits, sm_scale = create_test_data(
        bs, num_heads, num_kv_heads, head_dim, kv_len
    )

    for _ in range(200):
        triton_decode_attention(q, k_buf, v_buf, o, kv_indptr, kv_indices, num_splits, max_splits, sm_scale)
