...
|---|---|---|---|
| GEMM v1-v26 | `kernels/wmma_gemm.py` | 134 TFLOPS (v15+) | Iterative WMMA GEMM evolution |
...
| Decode Attn (Split-KV) | `kernels/wmma_decode_attention.py` | 38us BS=1 KV=1024 | Two-stage split-KV for large KV |
| Decode Attn (Elem) | `kernels/wmma_decode_attention.py` | 27us BS=1 KV=256 | No-WMMA reference implementation |
