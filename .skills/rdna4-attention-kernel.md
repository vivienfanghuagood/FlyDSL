...
| Split-KV (two-stage) | Stage1: parallel KV splits, Stage2: merge | BS≥8 or KV≥512 | `kernels/wmma_decode_attention.py` |
| Element-wise (single WG) | Wave-reduction dot products, no WMMA | Analysis/reference only | `kernels/wmma_decode_attention.py` |
